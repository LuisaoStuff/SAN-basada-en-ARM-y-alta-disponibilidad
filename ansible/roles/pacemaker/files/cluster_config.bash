...
pcs resource create iscsi-target ocf:heartbeat:iSCSITarget implementation="tgt" portals="192.168.1.200" iqn="iqn.2020-10.es.luisvazquezalejo:prueba" allowed_initiators="192.168.1.149 192.168.1.39 192.168.1.43 192.168.1.15" tid="1"  --group iscsi
# Creamos LUN1
